...
class Stone(pygame.sprite.Sprite):
    ...
    def __init__(self, stone_type, x, y, can_disappear):
        ...
        if self.__stone_type == 0:
            self.image = pygame.image.load("./MiscImages/stone_brick.jpg")
        elif self.__stone_type == 1:
            self.image = pygame.image.load("./MiscImages/cobble_stone.png")
        else:
            self.image = pygame.image.load("./MiscImages/moss_stone.png")
...
class Countdown(pygame.sprite.Sprite):
    def __init__(self):
        pygame.sprite.Sprite.__init__(self)
        self.__time = 15
        self.__font1 = pygame.font.Font("./Fonts/DIOGENES.ttf", 40)
        self.__font2 = pygame.font.Font("./Fonts/greekhouse.ttf", 18)
...
class GearTracker(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.__font = pygame.font.Font("./Fonts/geek.ttf", 22)
...
class HealthKeeper(pygame.sprite.Sprite):
    def __init__(self, screen):
        ...
        self.image_heart = pygame.image.load("./MiscImages/heart.png")
...
class Minotaur(pygame.sprite.Sprite):
    def __init__(self, screen, maze_arrangement):
        ...
        self.__walk_down = [pygame.image.load("./MinotaurImages/minotaur_stand_down.png"), \
                            pygame.image.load("./MinotaurImages/minotaur_walk1_down.png"), \
                            pygame.image.load("./MinotaurImages/minotaur_stand_down.png"), \
                            pygame.image.load("./MinotaurImages/minotaur_walk2_down.png"), \
                            pygame.image.load("./MinotaurImages/minotaur_stand_down.png")]
        
        self.__walk_up = [pygame.image.load("./MinotaurImages/minotaur_stand_up.png"), \
                          pygame.image.load("./MinotaurImages/minotaur_walk1_up.png"), \
                          pygame.image.load("./MinotaurImages/minotaur_stand_up.png"), \
                          pygame.image.load("./MinotaurImages/minotaur_walk2_up.png"), \
                          pygame.image.load("./MinotaurImages/minotaur_stand_up.png")]    
        
        self.__walk_right = [pygame.image.load("./MinotaurImages/minotaur_stand_right.png"), \
                             pygame.image.load("./MinotaurImages/minotaur_walk1_right.png"), \
                             pygame.image.load("./MinotaurImages/minotaur_stand_right.png"), \
                             pygame.image.load("./MinotaurImages/minotaur_walk2_right.png"), \
                             pygame.image.load("./MinotaurImages/minotaur_stand_right.png")]
        
        self.__walk_left = [pygame.image.load("./MinotaurImages/minotaur_stand_left.png"), \
                            pygame.image.load("./MinotaurImages/minotaur_walk1_left.png"), \
                            pygame.image.load("./MinotaurImages/minotaur_stand_left.png"), \
                            pygame.image.load("./MinotaurImages/minotaur_walk2_left.png"), \
                            pygame.image.load("./MinotaurImages/minotaur_stand_left.png")]
